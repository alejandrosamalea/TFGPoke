$(document).ready(function() {
    ...
    var idMaria = document.getElementById("maria").getAttribute("data-value");
    ...
    $("#idEntrenador").data("peleaMaria", "/combate/combateNPC?idEntrenador=" + idEntrenador + "&idNPC=" + idMaria + "&posicion=" + posicion + "&posicionY=" + posicionY);
    var enlace = $("#idEntrenador").data("enlace");
    var peleaMaria = $("#idEntrenador").data("peleaMaria");
    ...
    var tocandoMaria = false; // Nuevo estado para indicar si el personaje está tocando a María
    ...
    function checkCollision(newX, newY, direction) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (futureRect.right > elementRect.left &&
                ...
                if ($(elements[i]).hasClass('mariaColision')) {
                    tocandoMaria = true; // Actualiza el estado si el personaje está tocando a María
                } else {
                    tocandoMaria = false; // Reinicia el estado si el personaje ya no está tocando a María
                }
    ...
    $(document).keydown(function(e) {
        ...
        if (e.which === 13 && tocandoMaria) { // Mostrar el alert solo si se presiona Enter y el personaje está tocando a María
            window.location.href = peleaMaria;
