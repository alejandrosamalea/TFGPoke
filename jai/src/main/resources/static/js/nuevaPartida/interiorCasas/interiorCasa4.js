$(document).ready(function() {
    ...
    var dialogosNaara = [
        "Camarero:¿Puedes dejar de chocarte con todo?Sabia que no era buena idea dejarte beber tanto.",
        "Camarero:¡Cuidado con la pared! No está tan suave como parece cuando estás borracho.",
        "Camarero:Como sigas asi te voy a tener que echar fuera"
    ];
    var positionX = 0;
    var positionY = 0;
    var moving = false;
